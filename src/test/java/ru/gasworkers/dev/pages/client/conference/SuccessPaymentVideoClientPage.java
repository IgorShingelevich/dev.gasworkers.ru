...
public class SuccessPaymentVideoClientPage extends BaseClientPage {
    ...
    private final String
        ...
        subtitleText = "Вы успешно оплатили видеоконсультацию. Мастер получил заказ и начнет ее в течение 30 минут. Ожидайте СМС сообщения со ссылкой на консультацию.";
