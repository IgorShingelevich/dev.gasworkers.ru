...
public class fillTaxpayerCertificateCommonSelfEmployedComponent extends BaseOrderCardComponent {
    ...
    public fillTaxpayerCertificateCommonSelfEmployedComponent(RoleBrowser roleBrowser) {
        super(roleBrowser);
