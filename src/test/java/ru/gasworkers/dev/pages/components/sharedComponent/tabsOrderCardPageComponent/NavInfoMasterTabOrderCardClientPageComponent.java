...
public class NavInfoMasterTabOrderCardClientPageComponent extends BaseTabOrderCardComponent {
    ...
    public NavInfoMasterTabOrderCardClientPageComponent(RoleBrowser browser) {
        super(browser);
