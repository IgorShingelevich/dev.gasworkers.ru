...
public class FirstMaintenanceGuideComponent extends BaseComponent {
    ...
    private final String
        ...
        GUIDE_Step_7 = "Здесь Вы увидите информацию о сервисных компаниях, в которые направлен Ваш заказ, их рейтинг, местоположение офиса.",
        GUIDE_Step_8 = "Предложение сервисной компании откликнувшейся на Ваш заказ выглядит так, уведомление о котором поступит в личный кабинет на сайте, на электронную почту и смс на телефон.",
