...
public class fillBankAccountCommonSelfEmployedComponent extends BaseOrderCardComponent {
    public fillBankAccountCommonSelfEmployedComponent(RoleBrowser roleBrowser) {
        super(roleBrowser);
    }
