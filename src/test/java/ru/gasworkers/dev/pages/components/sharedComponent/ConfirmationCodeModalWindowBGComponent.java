...
public class ConfirmationCodeModalWindowBGComponent extends BaseComponent {
    ...
    private final String
        ...
        modalText = "Введите код подтверждения из СМС/письма пришедшего к вам на почту. Пожалуйста, проверьте папку СПАМ, если письмо с кодом подтверждения долго не приходит. После этого заказ разместится на платформе и будет виден сервисным компаниям.";
    SelenideElement
