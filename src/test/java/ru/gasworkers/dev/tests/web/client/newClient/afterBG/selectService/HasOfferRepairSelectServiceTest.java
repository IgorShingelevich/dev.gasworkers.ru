...
public class HasOfferRepairSelectServiceTest extends BaseTest {
    ...
    @Test
    @Owner("Igor Shingelevich")
    @DisplayName("Состояние Кабинета Клиента Есть Отклики - Выбор Исполнителя на Ремонт")
    public void hasOfferSelectServiceRepair() {
