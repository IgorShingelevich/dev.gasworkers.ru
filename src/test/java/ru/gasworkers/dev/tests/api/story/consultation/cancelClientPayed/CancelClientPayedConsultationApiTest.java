package ru.gasworkers.dev.tests.api.story.consultation.cancelClientPayed;
...
@Tag(AllureTag.API)
public class CancelClientPayedConsultationApiTest extends BaseApiTest {
    ...
    @EnumSource(CancelClientPayedCase.class)
    @Tag(AllureTag.POSITIVE)
    @DisplayName("Success case:")
    void positiveTestCase(CancelClientPayedCase testCase, @WithThroughUser(withOrderType = @WithOrderType(type = "consultation")) User client) {
