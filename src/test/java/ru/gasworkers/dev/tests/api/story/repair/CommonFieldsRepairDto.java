...
public class CommonFieldsRepairDto {
    private String tokenClient, tokenDispatcher, payment0Url, payment1Url, tokenMaster, orderNumber, clientEmail, clientRefererCode, approveDate, selectedDate;
    ...
    private Integer clientNotificationsCount, serviceId, dispatcherId, masterId, orderId, offerIdBeforePayment,
            ...
            receipts0Id, receipts1Id, receipts2Id, clientId, clientGuides0Id, payment0Id, payment1Id, objectId, clientRoles0PivotModelId, masters0CompletedOrdersCount;
}
