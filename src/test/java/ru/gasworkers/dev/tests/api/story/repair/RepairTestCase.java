...
public class RepairTestCase {
    ...
    private void populateLastOrderInfoFields(LastOrderInfoResponseDto expectedTemplateResponse, CommonFieldsRepairDto commonFields) {
        expectedTemplateResponse.getData().setId(commonFields.getOrderId());
        expectedTemplateResponse.getData().setNumber(commonFields.getOrderNumber());
        expectedTemplateResponse.getData().getClientObject().setId(commonFields.getClientObjectId());
        expectedTemplateResponse.getData().getEquipments().get(0).setId(commonFields.getEquipments0Id());
    ...
    private void populatePublishedOrderIdFields(OrdersIdResponseDto expectedTemplateResponse, CommonFieldsRepairDto commonFields) {
        expectedTemplateResponse.getData().setId(commonFields.getOrderId());
        expectedTemplateResponse.getData().setNumber(commonFields.getOrderNumber());
        expectedTemplateResponse.getData().getClientObject().getEquipments().get(0).setId(commonFields.getEquipments0Id());
        expectedTemplateResponse.getData().getClientObject().setId(commonFields.getClientObjectId());
    ...
    private void populateHasOfferOrderIdFields(OrdersIdResponseDto expectedTemplateResponse, CommonFieldsRepairDto commonFields) {
        expectedTemplateResponse.getData().setId(commonFields.getOrderId());
        expectedTemplateResponse.getData().setNumber(commonFields.getOrderNumber());
        expectedTemplateResponse.getData().getClientObject().getEquipments().get(0).setId(commonFields.getEquipments0Id());
        expectedTemplateResponse.getData().getClientObject().setId(commonFields.getClientObjectId());
    ...
    private void populateDateSelectingOrderIdFields(OrdersIdResponseDto expectedTemplateResponse, CommonFieldsRepairDto commonFields) {
        expectedTemplateResponse.getData().setId(commonFields.getOrderId());
        expectedTemplateResponse.getData().setPhone(commonFields.getClientPhone());
        expectedTemplateResponse.getData().setNumber(commonFields.getOrderNumber());
        expectedTemplateResponse.getData().getClientObject().getEquipments().get(0).setId(commonFields.getEquipments0Id());
    ...
    private void populateWaitMasterOrderIdFields(OrdersIdResponseDto expectedTemplateResponse, CommonFieldsRepairDto commonFields) {
        expectedTemplateResponse.getData().setId(commonFields.getOrderId());
        expectedTemplateResponse.getData().setNumber(commonFields.getOrderNumber());
        expectedTemplateResponse.getData().setPossibleOfferId(commonFields.getPossibleOfferId());
        expectedTemplateResponse.getData().getClientObject().getEquipments().get(0).setId(commonFields.getEquipments0Id());
    ...
    private void populateMaterialInvoiceIssuedOrderIdFields(OrdersIdResponseDto expectedTemplateResponse, CommonFieldsRepairDto commonFields) {
        expectedTemplateResponse.getData().setId(commonFields.getOrderId());
        expectedTemplateResponse.getData().setNumber(commonFields.getOrderNumber());
        expectedTemplateResponse.getData().setPossibleOfferId(commonFields.getPossibleOfferId());
        expectedTemplateResponse.getData().getClientObject().getEquipments().get(0).setId(commonFields.getEquipments0Id());
    ...
    private void populateActionInvoiceIssuedOrderIdFields(OrdersIdResponseDto expectedTemplateResponse, CommonFieldsRepairDto commonFields) {
        expectedTemplateResponse.getData().setId(commonFields.getOrderId());
        expectedTemplateResponse.getData().setNumber(commonFields.getOrderNumber());
        expectedTemplateResponse.getData().setPhone(commonFields.getClientPhone());
        expectedTemplateResponse.getData().setPossibleOfferId(commonFields.getPossibleOfferId());
