...
@Story("repair material invoice paid")
@Tag(AllureTag.REGRESSION)
@Tag(AllureTag.API)
public class MaterialInvoicePaidRepairApiTest extends BaseApiTest {
    ...
    @Test
    @DisplayName("material invoice paid repair")
    void materialInvoicePaid(@WithThroughUser(withOrderType = @WithOrderType(type = "repair")) User client) {
